...
namespace atlas {
    ...
    GLuint cg_shader::compile(const std::vector<shader_source*>& code)
    {
    ...
    GLuint cg_shader::load(const char* vertex_file, const char* fragment_file, const char* geometry_file /*= nullptr*/)
    {
    ...
    GLuint cg_shader::compile(const char* vertex_source, const char* fragment_source, const char* geom_source/* = NULL*/)
    {
        std::vector<shader_source*> code;
        if (vertex_source)
